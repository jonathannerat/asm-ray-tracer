...
%define LIST_SIZE            LIST_SURFACES_OFF+POINTER_SIZE ; 40 bytes

%define TRIANGLE_P1_OFF         SURFACE_SIZE
%define TRIANGLE_P2_OFF         TRIANGLE_P1_OFFS+VEC3_SIZE
%define TRIANGLE_P3_OFF         TRIANGLE_P2_OFFS+VEC3_SIZE
%define TRIANGLE_MATERIAL_OFF   TRIANGLE_P3_OFFS+VEC3_SIZE
%define TRIANGLE_SIZE           TRIANGLE_P3_OFFS+POINTER_SIZE ; 88 bytes
...
%define HITRECORD_SIZE           HITRECORD_FFACE_OFF+INT_SIZE ; 48 bytes
...
%define OUTPUT_HEIGHT_OFFS   INT_SIZE
%define OUTPUT_SPP_OFFS      INT_SIZE*2
%define OUTPUT_DEPTH_OFFS    INT_SIZE*3
